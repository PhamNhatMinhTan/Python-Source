...
def draw_lines(img, lines, color=[255, 0, 0], thickness=10):
    ...
    for line in lines:
        ...
        # Calculate slope
        if x2 - x1 == 0.0:  # corner case, avoiding division by 0
...
def filter_colors(image):
    ...
    image2 = cv2.addWeighted(white_image, 1.0, yellow_image, 1.0, 0.0)
...
if __name__ == "__main__":
    ...
    """
    input_file = "/home/tan/Python Source/video/test2.mp4"
    output_file = "/home/tan/Python Source/video/test2_output.mp4"
    image_only = False
